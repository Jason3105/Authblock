...
with open("contracts/QRScanLogger.sol", "r") as file:
...
QRScanLogger = w3.eth.contract(abi=abi, bytecode=bytecode)

print("Building transaction...")
nonce = w3.eth.get_transaction_count(address)
tx = QRScanLogger.constructor().build_transaction({
...
# 4. Save to .env.local
set_key(env_path, "NEXT_PUBLIC_QR_CONTRACT_ADDRESS", contract_address)
print("Updated .env.local with NEXT_PUBLIC_QR_CONTRACT_ADDRESS")

# Also save the ABI for the frontend
abi_file = "src/lib/QRContractABI.json"
